                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="width45">
                                            ...
                                            <img src="<?= $site_url ?>/assets/images/xs/avatar2.jpg" class="rounded-circle avatar" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="width45">
                                            ...
                                            <img src="<?= $site_url ?>/assets/images/xs/avatar3.jpg" class="rounded-circle avatar" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="width45">
                                            ...
                                            <img src="<?= $site_url ?>/assets/images/xs/avatar4.jpg" class="rounded-circle avatar" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="width45">
                                            ...
                                            <img src="<?= $site_url ?>/assets/images/xs/avatar5.jpg" class="rounded-circle avatar" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="width45">
                                            ...
                                            <img src="<?= $site_url ?>/assets/images/xs/avatar6.jpg" class="rounded-circle avatar" alt="">
                                        </td>
                                        <td>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group mr">
                            <input type="text" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Tanggal Lahir *">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea class="form-control" rows="2" placeholder="Alamat *"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
