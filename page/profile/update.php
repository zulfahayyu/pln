...
<form action="<?= $site_url ?>/proses/model_profile.php?update=true&id=<?= $pegawai['id'] ?>" method="POST">
    <div class="modal-body">
        <div class="row clearfix">
            ...
            <div class="col-sm-7">
                <div class="form-group">
                    <input type="text" name="email" value="<?= $pegawai['email'] ?>" class="form-control" placeholder="Email *" required>
                </div>
            </div>
            <div class="col-sm-5">
                <div class="form-group">
                    <input type="text" name="phone" value="<?= $pegawai['phone'] ?>" class="form-control" placeholder="Nomor Telp *" required>
                </div>
            </div>
