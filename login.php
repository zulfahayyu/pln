...
<!-- Mirrored from thememakker.com/templates/lucid/hr/html/light/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Dec 2018 05:19:14 GMT -->
    ...
    <div id="wrapper">
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle auth-main">
                <div class="auth-box">
                    <div class="top">
                        <img src="assets/img/logo_PLN.png" alt="PLN">
                    </div>
                    <div class="card">
                        <div class="header">
